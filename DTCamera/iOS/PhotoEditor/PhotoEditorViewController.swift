...
class PhotoEditorViewController: UIViewController {
    ...
    private let rotateLabelButton = UIButton()
    ...
    private func setupControls() {
        ...
        rotateLabelButton.setAttributedTitle(rotateButtonTitle, for: .normal)
        rotateLabelButton.addTarget(self, action: #selector(rotate), for: .touchUpInside)

        doneButton.setImage(#imageLiteral(resourceName: "done"), for: .normal)
        doneButton.addTarget(self, action: #selector(done), for: .touchUpInside)
        
        view.addSubview(dismissButton)
        rotateView.addSubview(rotateButton)
        rotateView.addSubview(rotateLabelButton)
        ...
        rotateLabelButton.snp.makeConstraints { make in
            make.right.equalToSuperview()
            make.left.equalTo(rotateButton.snp.right).offset(8)
            make.centerY.equalToSuperview()
        }
        dismissButton.snp.makeConstraints { make in
            make.left.equalToSuperview().offset(12)
            make.centerY.equalTo(rotateView)
        }
